...
namespace SeleniumRecipes
{
    ...
    public class RadioButtonTest
    {
        ...
        public void TestSelectRadioByNameAndValue()
        {
            ...
            //driver.FindElement(By.XPath("//*[@id='radio_male' and @value='male']")).Click();
            driver.FindElement(By.XPath("//*[@id='radio_male']")).Click();
            //*[@id="radio_male"]
            //*[@id="radio_female"]
        }
        ...
        public void TestClickRadioOptionByTheFollowingLabel()
        {
            ...
            //elem.Click();
            //*[@id="QuestionViewModels_1__SelectedAnswerId
            IWebElement elem = driver.FindElement(By.XPath("//*[@id='q1']/div/div[1]/label"));
            //*[@id="q1"]/div/div[1]/label
            //*[@id="q1"]/div/div[2]/label
            elem.Click();
